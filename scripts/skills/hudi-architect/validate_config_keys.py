...
Run from anywhere:  python3 scripts/skills/hudi-architect/validate_config_keys.py
"""
...
REPO_ROOT = SKILL_DIR.parents[2]  # scripts/skills/hudi-architect -> repo root
...
def main():
    ...
    if not valid:
        ...
        print("       (scripts/skills/hudi-architect/), not from an installed copy under")
